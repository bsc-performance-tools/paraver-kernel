...
constexpr char OLDCFG_TAG_WNDW_INTRACOMMS_FILTERED[]        = "window_intracomms_enabled";
constexpr char OLDCFG_TAG_WNDW_INTERCOMMS_FILTERED[]        = "window_intercomms_enabled";
...
constexpr char CFG_TAG_AN2D_OBJECTS[]            = "Analyzer2D.Objects:"; // Old implementation. Keep it for compatibility with old cfgs.
constexpr char CFG_TAG_AN2D_OBJECT[]             = "Analyzer2D.Object:";
constexpr char CFG_TAG_AN2D_DRAWMODE_OBJECTS[]   = "Analyzer2D.DrawModeObjects:";
constexpr char CFG_TAG_AN2D_DRAWMODE_COLUMNS[]   = "Analyzer2D.DrawModeColumns:";
...
static const std::string FULL_LABEL_TIMEUNIT[ DAY + 1 ] = { "Nanoseconds", "Microseconds", "Milliseconds", "Seconds", "Minutes", "Hours", "Days" };
...
static const std::string TimelineLevelLabels[ DERIVED + 1 ] = {
  "None",          "Workload",      "Application",      "Task",         "Thread",       "System",         "Node",           "CPU",
  "Top Compose 1", "Top Compose 2", "Compose Workload", "Compose Appl", "Compose Task", "Compose Thread", "Compose System", "Compose Node",
  "Compose CPU",   "Derived"
};
...
static const std::string SingleTimelinePropertyLabels[ SINGLE_NULL ] = { "Name",
                                                                         "Begin time",
                                                                         "End time",
                                                                         "Semantic Minimum",
                                                                         "Semantic Maximum",
...
static const std::string DerivedTimelinePropertyLabels[ DERIVED_NULL ] = { "Name",
                                                                           "Begin time",
                                                                           "End time",
                                                                           "Semantic Minimum",
                                                                           "Semantic Maximum",
